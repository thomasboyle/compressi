...

{
    ...
    /// Single-pass constrained bitrate encode for EightMB corrective re-encodes.
...

    {
...

        {
            ...
            // Cap peaks so the 8 MB bag is less likely to need a full re-encode.
