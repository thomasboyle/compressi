...

{
    ...
    private static void AppendEncoderArgs(List<string> args, CompressionJob job, int crf, int preset)

    {
...

        {
            ...
            VideoEncoderArgumentBuilder.AppendGpuAv1Args(args, job.GpuEncoder!, crf);
